...
# Path strings. With docker configuration: data directories shall be placed in common directory with 'bot' directory 
p_path = './pickle/'
...
model_save_path = './saved_models/' #Path to save model benchmarks
...
ce_path = max(Path(model_save_path).glob('training*/'), key=os.path.getmtime)
